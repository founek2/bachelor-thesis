...
\keywordsCS{IoT Platforma, OpenSource, implementace, PWA, MQTT, ESP8266}
...
\begin{introduction}
    ...
    Teoretická část práce se věnuje rešerži aktualních řešení na trhu, jejich vzájemným porovnáním a návrhem vlastního. Praktická část se zaměřuje na implementaci a nasazení vlastního řešení.
