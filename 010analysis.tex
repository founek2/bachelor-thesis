\chapter{Analýza}
Tato kapitola se zabývá definicí IOT Platformy, analýzou již existujících řešení a jejich vzájemným porovnáním, v závěru kapitoly následně návrhem vlastního řešení.
...
Komunikaci mezi zařízeními lze realizovat propojením kabely či bezdrátově. Drátové propojení je finančně nákladnější a především znamená obrovský zásah do stávající infrastrukturu domu. Proto se pro komunikaci mezi zařízeními nejčastěji využívá bezdrátová komunikace, která umožňuje snadnou instalaci i ve starších domech. Bezdrátový přenos lze rozdělit do dvou kategorií:
\begin{itemize}
